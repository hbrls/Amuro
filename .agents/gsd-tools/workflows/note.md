...
- **Global scope**: `/Users/shuaizhexu/github/Amuro/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/shuaizhexu/github/Amuro/notes/`)
...
2. Glob `/Users/shuaizhexu/github/Amuro/notes/*.md` (if directory exists) — global notes
...
Global (/Users/shuaizhexu/github/Amuro/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/shuaizhexu/github/Amuro/notes/` — works in any directory
