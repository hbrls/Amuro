...
```bash
INIT=$(node "/Users/shuaizhexu/github/Amuro/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/shuaizhexu/github/Amuro/get-shit-done/bin/gsd-tools.cjs" commit \
