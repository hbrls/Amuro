...
```bash
INIT=$(node "/Users/shuaizhexu/github/Amuro/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/shuaizhexu/github/Amuro/get-shit-done/templates/spec.md.
