...
```
Agent(
  prompt="Read /Users/shuaizhexu/github/Amuro/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/shuaizhexu/github/Amuro/get-shit-done/templates/SECURITY.md`
